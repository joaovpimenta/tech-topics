...
Every cover must be a visibly painted editorial watercolor on textured paper, following `docs/VISUAL_STYLE.md`. Use `assets/<slug>/<slug>-cover.jpg` for covers; SVG, HTML and CSS are reserved for precise diagrams and charts, not substitutes for a watercolor cover.
